...
INSERT INTO `categoria` (`idCategoria`, `Cat_Descripcion`) VALUES
	...
	(2, 'Profesor de Tiempo Completo Asistente'),
	(3, 'Profesor de Tiempo Completo Asociado'),
	(4, 'Profesor de Tiempo Completo Titular'),
	(5, 'Profesor de Medio Tiempo Asistente'),
	(6, 'Profesor de Medio Tiempo Asociado');
...
INSERT INTO `rol` (`idRol`, `Rol_Descripcion`, `Usuario_idUsuario`, `Correo_rol`, `password`, `Carrera_idCarrera`) VALUES
	...
	(8, 'Coordinador Electronica', 6, 'electronica.fiad@uabc.edu.mx', '$argon2id$v=19$m=4096,t=3,p=1$CzlFyDYURLQOymmgDwXDWgefDXel+kCY44eyTY8tUns$5AJ8WEVOaSe+4H9v0buVy9CNgcNnEvBdGUimWoOfGbs', 3),
	...
	(11, 'Coordinador Nanotecnologia ', 9, 'coord.nano.fiad@uabc.edu.mx', '$argon2id$v=19$m=4096,t=3,p=1$CzlFyDYURLQOymmgDwXDWgefDXel+kCY44eyTY8tUns$5AJ8WEVOaSe+4H9v0buVy9CNgcNnEvBdGUimWoOfGbs', 7),
...
CREATE TABLE IF NOT EXISTS `solicitud` (
  ...
  `Reporte_Final` varchar(255) DEFAULT NULL,
